...
// CHECK: error{{.*}}insert range [4, 5) exceeds source width 4
waveasm.program @insert_oob
  ...
  %bad = waveasm.insert %word into %s0[4] : !waveasm.sreg, !waveasm.sreg<4, 4> -> !waveasm.sreg<4, 4>
  waveasm.s_endpgm
}
