...
static LogicalResult handleMakeBufferRsrc(ROCDL::MakeBufferRsrcOp op,
  ...
  if (needsPatch) {
    ...
    word1 = S_AND_B32::create(builder, loc, sregTy, ctx.createSCCType(), word1, maskVal).getDst();
    ...
    if (baseOff) {
      ...
      word0 = addLo.getDst();
      word1 = S_ADDC_U32::create(builder, loc, sregTy, sccTy, addLo.getScc(), word1, offHi)
                  .getDst();
    }
