...
def get_two_pp_cluster_schedule():
    ...
    1. 2-stage pipeline (prefetch global loads, compute with shared memory loads)
    2. Fine-grained clustering to hide memory latency
    3. 2-way wave staggering for better resource utilization
